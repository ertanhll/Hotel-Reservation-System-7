...
public class Main {
	...
	public static void main(String[] args) {
		...
		List<Calculable> calcList = new ArrayList<>();
			...
			case I:
				...
				for (Service service : services) {
					if (service instanceof Reservation) {
						...
						for (Service reservation : services) {
							if (reservation instanceof Reservation && reservation.getCustomerID() == spa.getCustomerID()
						...
						for (Service reservation : services) {
							if (reservation instanceof Reservation
									&& reservation.getCustomerID() == laundry.getCustomerID()
									&& ((Reservation) reservation).getReservationMonth().equals(chosenMonth)) {
				...
				for (Calculable desiredList : calcList) {
